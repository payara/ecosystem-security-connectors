 ...
 *  holder.
 */
package fish.payara.securityconnector.oauth2.api;

import fish.payara.securityconnector.oauth2.OAuth2AuthenticationMechanism;
...
public class OAuth2State implements Serializable {
     ...
     * but is not used by the {@link OAuth2AuthenticationMechanism} by default
     * @param state 
     */
