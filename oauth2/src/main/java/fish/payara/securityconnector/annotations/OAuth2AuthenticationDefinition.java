 ...
 *  holder.
 */
package fish.payara.securityconnector.annotations;
...
public @interface OAuth2AuthenticationDefinition {
     ...
     * {@code payara.security.oauth2.authEndpoint}.
     *
     * @return
     */
    String authEndpoint();
     ...
     * <p>
     * To set this using Microprofile Config use
     * {@code payara.security.oauth2.tokenEndpoint}
     *
     * @return
     */
     ...
     * <p>
     * To set this using Microprofile Config use
     * {@code payara.security.oauth2.cliendId}
     *
     ...
     * </p>
     * To set this using Microprofile Config use
     * {@code payara.security.oauth2.clientSecret}
     *
     * @return
     * @see
     ...
     * The callback URI.
     * <p>
     * If supplied this must be equal to one set in the OAuth2 Authentication
     * provider.
     * <p>
     * To set this using Microprofile Config use
     * {@code payara.security.oauth2.redirectURI}
     *
     * @return
     */
     ...
     * <code>{@value}</code>
     */
    String OAUTH2_MP_AUTH_ENDPOINT = "payara.security.oauth2.authEndpoint";

    /**
     * The Microprofile Config key for the token Endpoint is
     * <code>{@value}</code>
     */
    String OAUTH2_MP_TOKEN_ENDPOINT = "payara.security.oauth2.tokenEndpoint";

    /**
     * The Microprofile Config key for the clientId is <code>{@value}</code>
     */
    String OAUTH2_MP_CLIENT_ID = "payara.security.oauth2.clientId";

    /**
     * The Microprofile Config key for the client secret is
     * <code>{@value}</code>
     */
    String OAUTH2_MP_CLIENT_SECRET = "payara.security.oauth2.clientSecret";

    /**
     * The Microprofile Config key for the redirect URI is <code>{@value}</code>
     */
    String OAUTH2_MP_REDIRECT_URI = "payara.security.oauth2.redirectURI";

    /**
     * The Microprofile Config key for the scope is <code>{@value}</code>
     */
    String OAUTH2_MP_SCOPE = "payara.security.oauth2.scope";
