...
import static fish.payara.securityconnector.openid.api.OpenIdConstant.ACCESS_TOKEN;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.IDENTITY_TOKEN;
import fish.payara.securityconnector.openid.api.AccessToken;
import fish.payara.securityconnector.openid.api.IdentityToken;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.EXPIRES_IN;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.SCOPE;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.TOKEN_TYPE;
import fish.payara.securityconnector.openid.domain.AccessTokenImpl;
import fish.payara.securityconnector.openid.domain.IdentityTokenImpl;
