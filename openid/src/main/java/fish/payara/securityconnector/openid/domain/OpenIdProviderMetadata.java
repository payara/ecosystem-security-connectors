 ...
 *  holder.
 */
package fish.payara.securityconnector.openid.domain;

import static fish.payara.securityconnector.openid.api.OpenIdConstant.CLAIMS_SUPPORTED;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.ID_TOKEN_ENCRYPTION_ALG_VALUES_SUPPORTED;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.ID_TOKEN_ENCRYPTION_ENC_VALUES_SUPPORTED;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.ID_TOKEN_SIGNING_ALG_VALUES_SUPPORTED;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.ISSUER;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.RESPONSE_TYPES_SUPPORTED;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.SCOPES_SUPPORTED;
import static fish.payara.securityconnector.openid.api.OpenIdConstant.SUBJECT_TYPES_SUPPORTED;
import java.net.URL;
