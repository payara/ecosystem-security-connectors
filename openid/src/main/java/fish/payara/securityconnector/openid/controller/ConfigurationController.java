...
public class ConfigurationController {
    ...
    public OpenIdConfiguration buildConfig(OpenIdAuthenticationDefinition definition) {
        ...
        fish.payara.securityconnector.annotations.OpenIdProviderMetadata providerMetadata = definition.providerMetadata();
        ...
        OpenIdConfiguration configuration = new OpenIdConfiguration()
                .setProviderMetadata(
                        new fish.payara.securityconnector.openid.domain.OpenIdProviderMetadata(providerDocument)
