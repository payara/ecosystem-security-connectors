...
public class ClientSecretBasic implements ClientAuthentication {
     ...
     */
    public ClientSecretBasic(final String clientId, final char[] clientSecret) {
    ...
    public final Map<String, String> getRequestHeaders() {
        final String credentials = clientId + ":" + String.valueOf(clientSecret);
        final String basicAuth = Base64.getEncoder().encodeToString(credentials.getBytes(UTF_8));
        return Collections.singletonMap(OpenIdConstant.AUTHORIZATION_HEADER, OpenIdConstant.BEARER_TYPE + basicAuth);
    }
