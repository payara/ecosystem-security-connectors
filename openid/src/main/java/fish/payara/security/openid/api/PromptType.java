...
public enum PromptType {
     ...
     * requested Claims. ErrorCode : login_required, interaction_required
     */
    NONE,
    /**
     ...
     * return an error. ErrorCode : consent_required
     *
     */
    CONSENT,
    /**
     ...
     * end-user, it must return an error. ErrorCode : account_selection_required
     *
     */
    SELECT_ACCOUNT;
